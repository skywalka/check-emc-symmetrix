...
cap_lable=`echo $line | awk '{print $29}' | awk -F"=" '{print $1}'`
capacity=`echo $line | awk '{print $29}' | awk -F"=" '{print $2}'`
if [ $? -eq 0 -a $capacity -ne 0 ]; then
  used_lable=`echo $line | awk '{print $30}' | awk -F"=" '{print $1}'`
  used=`echo $line | awk '{print $30}' | awk -F"=" '{print $2}'` 
